...
from teste02 import Ui_MainWindow 
...
class Exemplo(QMainWindow):
    def __init__(self):
        ...
        self.ui.botao.clicked.connect(self.exibirNome)
    ...
    def exibirNome(self):
        ...
        self.ui.resultado.setText(f"Olá, {nome}!")
